...
func NewUnsafeAccessor(entity interface{}) (*Accessor, error) {
	if entity == nil {
	...
	return &Accessor{entityAddr: val.UnsafePointer(), fields: fields}, nil
}

func (u *Accessor) Field(field string) (int, error) {
...
func (u *Accessor) SetField(field string, val int) error {
	fdMeta, ok := u.fields[field]
	if !ok {
